...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000000 ????? ????? 101 ????? 01100 11", srl    , R, R(rd) = (unsigned)src1 >> (src2 & 0x1F));
  ...
  INSTPAT("0000000 ????? ????? 101 ????? 00100 11", srli   , I, R(rd) = (unsigned)src1 >> (imm & 0x1F));
  ...
  // INSTPAT("0000000 00000 00000 000 00000 11100 11", ecall  , N, ecall_handler(s)); // Implement your own ecall handler
